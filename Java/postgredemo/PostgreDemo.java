...
A demo of how to connect and query a PostgreSQL database through JDBC
in Java.

Note: The PostgreSQL jar file must be in your classpath.
...
public class PostgreDemo {
	...
	public static ArrayList get_clients(ResultSet rs)
        ...
        {
        	ResultSet rs;
	        String url = "jdbc:postgresql:pythonbyte";

        	try {
                	Class.forName("org.postgresql.Driver");
                }
                catch (ClassNotFoundException e) {
                	System.out.println("It appears you don't have the Postgres JDBC driver installed");
                }
